...
// ==========================================
// Using 'service: gmail' automatically handles ports and security.
...
// --- CONNECTION TEST (Check Server Logs) ---
...
// ==========================================
// This helper prevents the server from crashing if Mongoose hasn't compiled the model yet.
const getModel = (name) => {
    if (mongoose.models[name]) {
        return mongoose.model(name);
    }
    // Fallback: This handles the race condition on some servers
    return mongoose.model(name);
};
